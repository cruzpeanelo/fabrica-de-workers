...
def create_demo_data():
    ...
    try:
        ...
        print("-" * 50)
        print("  platform_admin / admin123  -> Super Admin (todos)")
        print("  belgo_admin / belgo123     -> Admin Belgo (azul)")
        print("  belgo_pm / belgo123        -> PM Belgo")
        print("  tech_admin / tech123       -> Admin TechCorp (roxo)")
        print("  tech_dev / tech123         -> Dev TechCorp")
        print("  startup_dev / startup123   -> Dev StartupX (verde)")
        print("  consultor / consul123      -> Multi-tenant")
        print("-" * 50)
