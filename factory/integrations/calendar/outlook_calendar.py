...
class OutlookCalendarClient:
    ...
    async def sync_sprint(
        ...
        event = OutlookCalendarEvent(
            ...
            body=f"<h2>Sprint Goal</h2><p>{goal}</p><hr><p><em>Plataforma E - Sprint Tracking</em></p>",
    ...
    async def sync_deadline(
        ...
        event = OutlookCalendarEvent(
            ...
            body=f"<h3>Priority: {priority.upper()}</h3><p>{description}</p><hr><p><em>Plataforma E</em></p>",
